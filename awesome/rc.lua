...
-- ez.keyboard.global[{alt, ctrl, "p"}] = focus_up_client
-- ez.keyboard.global[{alt, ctrl, "s"}] = focus_right_client
-- ez.keyboard.global[{alt, ctrl, "n"}] = focus_down_client
-- ez.keyboard.global[{alt, ctrl, "t"}] = focus_left_client
