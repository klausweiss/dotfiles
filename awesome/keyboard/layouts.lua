...
local globalkeys = gears.table.join(
  ...
  awful.key({ modkey,           }, ".", function () awful.screen.focus_bydirection("right", awful.screen.focused()) end,
        {description = "focus the next screen", group = "screen"}),
  awful.key({ modkey,           }, "m", function () awful.screen.focus_bydirection("left", awful.screen.focused()) end,
